...
└── requirements.txt
```
> Nota: El archivo `sql-murder-mystery.db` no se incluye en el repositorio.  
> Debe descargarse desde:  
> http://mystery.knightlab.com/sql-murder-mystery.db

## Setup

### 1. Clonar el repositorio

- git clone (https://github.com/Angelica26-DS/TC-sql-TechZone.git)
- cd TC-SQL-TECHZONE
